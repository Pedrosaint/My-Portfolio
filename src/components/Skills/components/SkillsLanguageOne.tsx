...
const SkillsLanguageOne: React.FC<Props> = ({skill1, skill2, skill3, level1, level2, level3,}) => {
  return (
    <>
      <div>
        <div className="relative mb-[3rem] md:mb-[8rem]">
...
export default SkillsLanguageOne