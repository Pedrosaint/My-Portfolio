            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 border border-gray-700 rounded-lg">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-100 bg-gray-800 border border-gray-700 rounded-md hover:bg-gray-700"
                >
                  📂 View Source Code
                </a>
              </div>
